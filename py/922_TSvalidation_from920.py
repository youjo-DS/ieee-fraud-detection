...
def ts_split(X_train, y_train, n_splits):
...
trn_idx_list, val_idx_list = ts_split(X_train, y_train, n_splits=NFOLD+3)
trn_idx_list = trn_idx_list[3:]
val_idx_list = val_idx_list[3:]

assert len(trn_idx_list) == NFOLD
assert len(val_idx_list) == NFOLD
