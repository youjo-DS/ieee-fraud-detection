...
# load data
# =============================================================================
X_train = pd.read_pickle('../input/pickle/X_train.pkl')
y_train = pd.read_pickle('../input/pickle/y_train.pkl')
test  = pd.read_pickle('../input/pickle/X_test.pkl')

trn_idx = np.load('../feature/trn_idx.npy')
val_idx = np.load('../feature/val_idx.npy')
